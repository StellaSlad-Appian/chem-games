              ...
              {score.highestScore !== null ? (
                <div className="flex justify-between items-end">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xl font-black text-indigo-600">#{score.globalRank}</p>
                  </div>
                </div>
              ) : (
                <div className="py-2 text-center bg-slate-100 rounded-xl border-2 border-slate-200">
                  ...
                  <button className="mt-2 text-sm font-black text-indigo-600 hover:text-indigo-800 uppercase">
                    Play Now ▶
                  </button>
                </div>
              )}
