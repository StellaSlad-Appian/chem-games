...
export const EXPLORE_OVERLAY_ES = {
  molecules: {
    benzene: {
      name: 'Benceno',
      everyday:
        'El benceno es uno de los componentes ligeros de la gasolina, y se fabrica en cantidades enormes como materia prima de plásticos, nailon y colorantes. Seguramente nunca tengas delante un frasco de benceno. Su anillo, en cambio, lo tienes cerca todo el rato: ese hexágono de seis carbonos está en el corazón del paracetamol, del poliestireno y de varios aminoácidos de tu propio cuerpo. El benceno es una causa reconocida de leucemia. Por eso la ley de la Unión Europea limita al uno por ciento en volumen la cantidad que puede llevar el combustible. Y por eso las gasolineras se construyen para estar siempre ventiladas.',
      chemistry:
        'El anillo son seis carbonos en un hexágono plano, cada uno con un hidrógeno hacia fuera. Lo raro es que seis de sus electrones no pertenecen a ningún enlace concreto. Están repartidos por todo el anillo, por encima y por debajo del hexágono. Ese reparto explica que el benceno sea mucho menos reactivo de lo que harían pensar tres enlaces dobles. También explica que los seis enlaces entre carbonos midan exactamente lo mismo en lugar de alternar cortos y largos.',
    },

    'citric-acid': {
      name: 'Ácido cítrico',
      everyday:
        'El ácido cítrico es lo que hace que un limón pique: supone alrededor del cinco por ciento del peso del zumo de limón. También es el polvo agrio que recubre las chucherías, el punto ácido de un refresco, el ingrediente activo del antical de la cafetera. Se añade además a casi cualquier conserva, donde da sabor y ayuda a que el contenido no se estropee. La mayor parte del ácido cítrico que se vende no se exprime de ninguna fruta: se obtiene alimentando con azúcar a un moho que lo produce por toneladas.',
      chemistry:
    ...
    ammonia: {
      ...
      chemistry:
        'El nitrógeno se coloca en el centro con tres hidrógenos alrededor y un par de electrones que le sobra. Ese par empuja la molécula hasta darle forma de pirámide achatada en lugar de triángulo plano. Ese par sobrante lo explica todo. Está libre para capturar un ion hidrógeno, que es lo que hace del amoniaco una base, y es lo que le permite unirse tan bien al agua por enlaces de hidrógeno. En la industria se construye a partir de N2 y H2: el nitrógeno sale del aire y el hidrógeno suele salir del gas natural. Por eso fabricarlo produce además muchísimo dióxido de carbono.',
    },
    ...
    'oleic-acid': {
      name: 'Ácido oleico',
      everyday:
        'El ácido oleico es el ácido graso principal del aceite de oliva, alrededor de tres cuartas partes. También es casi todo lo que hay en el aceite de colza, en las almendras y en los aguacates. Es la razón de que esos aceites sigan líquidos dentro del armario. La misma molécula es buena parte de la grasa que produce tu propia piel.',
      chemistry:
        'La molécula es una cadena de dieciocho carbonos con un grupo ácido carboxílico en un extremo y un único enlace doble en mitad de la cadena. Ese enlace doble es cis: las dos mitades de la cadena salen por el mismo lado, así que la cadena lleva un codo permanente. Las cadenas con codo no pueden apilarse bien unas contra otras, de modo que siguen líquidas a temperaturas en las que las rectas ya han solidificado. Esa es toda la diferencia entre un aceite y una grasa dura. Añade hidrógeno a ese enlace doble sobre un catalizador de níquel y obtienes ácido esteárico: dieciocho carbonos, sin codo, sólido a temperatura ambiente. Hecho sobre grasas de verdad, así es como un aceite líquido se convierte en margarina.',
    },

    methane: {
      name: 'Metano',
      everyday:
        'El metano es el gas natural. Calienta casas, cocina la comida y genera alrededor de la quinta parte de la electricidad del mundo. También se escapa de las marismas, de los arrozales y de los vertederos, y sale de las vacas. Como gas de efecto invernadero es mucho más potente que el dióxido de carbono. Aun así, se descompone en la atmósfera en cosa de una década, cosa que el dióxido de carbono no hace.',
      chemistry:
    ...
    water: {
      everyday:
        'El agua cubre casi todo el planeta, es alrededor del 60 por ciento de ti y es la única sustancia corriente que puedes encontrarte sólida, líquida y gaseosa el mismo día. También es la razón de que un estanque se hiele empezando por la superficie: el agua sólida es menos densa que la líquida. Eso es tan poco habitual que casi no tiene ningún otro ejemplo.',
      chemistry:
        'El oxígeno aporta seis electrones externos y comparte dos, uno con cada hidrógeno. Le quedan dos pares sin compartir: los pares solitarios. Los cuatro pares se empujan entre sí. Como los pares solitarios ocupan más sitio que los pares enlazantes, la molécula acaba doblada, con un ángulo de unos 104,5 grados en lugar de quedar recta. Una molécula doblada y con un oxígeno que tira de los electrones hacia sí tiene un extremo negativo y otro positivo, así que las moléculas se pegan unas a otras. Esa pegajosidad explica que el agua siga líquida a 80 °C, cuando algo tan ligero no tendría por qué ser otra cosa que un gas.',
    },
    ...
    adenine: {
      ...
      chemistry:
        'La molécula son dos anillos fusionados, uno de seis miembros y otro de cinco, con átomos de nitrógeno incrustados en los dos. Los químicos llaman purina a esa disposición. De uno de los anillos cuelga un grupo amino. En el ADN, ese grupo amino y uno de los nitrógenos del anillo forman dos enlaces de hidrógeno con una timina de la hebra de enfrente. Exactamente dos: por eso la adenina se empareja con la timina y no con la citosina, que necesita tres. El emparejamiento no tiene nada de magia. Son enlaces de hidrógeno que encajan o no encajan.',
    },

    'sodium-bicarbonate': {
      everyday:
        'Esto es el bicarbonato de toda la vida. Hace que los bizcochos suban, pone las burbujas en una bomba de baño y el alivio en una pastilla para la acidez de estómago. Es además lo que llevan dentro muchos extintores de polvo. El mismo compuesto está disuelto en tu sangre, donde su trabajo es evitar que la acidez se descontrole cuando haces ejercicio.',
      chemistry:
    ...
    'sodium-chloride': {
      everyday:
        'Sal de mesa. Se extrae de minas de roca, se evapora del mar, se esparce sobre las carreteras heladas. La industria química la usa como punto de partida para el cloro, el hidróxido de sodio y el ácido clorhídrico. Tu cuerpo necesita algo de sal de verdad, y la mayoría de la gente toma bastante más que algo.',
      chemistry:
        'En un grano de sal no hay moléculas de cloruro de sodio. El cristal son iones sodio e iones cloruro alternándose en todas las direcciones. Cada sodio está rodeado de seis cloruros y cada cloruro de seis sodios, repitiéndose igual durante miles de millones de iones seguidos. La fórmula es una proporción, uno a uno, no un recuento de los átomos de una molécula. Ese patrón que se repite sin fin es lo que lo convierte en un cristal. Es también la razón de que un grano se parta en cubitos: lo estás separando por los planos sobre los que los iones ya estaban alineados.',
    },
  },
  ...
  scientists: {
    ...
    'marie-maynard-daly': {
      work: 'Marie Maynard Daly trabajó en dos problemas bastante distintos. En el Instituto Rockefeller, desde 1948 y junto a Alfred Mirsky, estudió la química del núcleo celular. Es decir, las proteínas histonas alrededor de las cuales se enrolla el ADN, y de qué están hechos los ácidos nucleicos. A partir de 1955, con el médico Quentin Deming, se pasó a las arterias. Sus experimentos, hechos sobre todo con ratas con la tensión alta, estuvieron entre los primeros que ataron entre sí tres cosas que se habían estudiado por separado. Eran la tensión arterial alta, el colesterol y el estrechamiento de las arterias.',
      legacy:
    ...
    'reatha-clark-king': {
      work: 'Para juzgar si un propulsante de cohete merece la pena hace falta un número: cuánta energía sale exactamente cuando arde. Reatha Clark King midió esos números para compuestos de flúor en la Oficina Nacional de Normas de Estados Unidos, en los años sesenta. El flúor es el elemento más reactivo que existe, y el difluoruro de oxígeno ataca casi cualquier cosa dentro de la que intentes quemarlo. King diseñó un quemador de níquel con un tubo en espiral que permitía enfriar y controlar la llama en lugar de destrozar el aparato. Con él obtuvo un calor de formación del difluoruro de oxígeno lo bastante preciso como para publicarlo. Le valió el premio de la oficina al mejor artículo del año.',
      legacy:
    ...
    'alfred-werner': {
      work: 'Algunos compuestos se negaban a encajar en las reglas. El cloruro de cobalto con seis moléculas de amoniaco unidas se comportaba como si sus tres cloruros estuvieran sueltos; con cinco amoniacos, solo lo estaban dos. En 1893, Alfred Werner, que tenía entonces 26 años, dijo que la razón es que un ion metálico tiene dos cosas distintas en juego. Una es una carga que equilibrar. La otra es un número fijo de sitios a su alrededor donde pueden engancharse moléculas o iones. Para el cobalto ese número es seis, colocados en los vértices de un octaedro. Werner no podía ver nada de esto. Lo demostró contando: un octaedro predice exactamente dos formas de un compuesto con cuatro grupos de una clase y dos de otra, y dos era siempre lo que encontraba.',
      legacy:
    ...
    'johanna-dobereiner': {
      work: 'Las leguminosas – judías, guisantes, soja – no necesitan que les des nitrógeno. Alojan bacterias en unos nódulos de sus raíces, y esas bacterias toman N2 directamente del aire y lo convierten en amoniaco que la planta puede usar. Johanna Döbereiner, que trabajaba en Brasil desde 1950, se preguntó si aquello podía sostener un cultivo comercial en suelo tropical. La agricultura brasileña de entonces copiaba el modelo estadounidense y echaba fertilizante nitrogenado a espuertas. Buscó cepas de Bradyrhizobium adaptadas a los suelos brasileños y a las variedades brasileñas de soja, las probó en el campo. Llevó los resultados hasta un programa nacional de tratamiento de la semilla. Su grupo describió además varias especies fijadoras de nitrógeno nuevas.',
      legacy:
    ...
    'giulio-natta': {
      ...
      credit:
        'A Ziegler no le hizo ninguna gracia compartirlo. Natta había llegado a la reacción a partir de la química de catalizadores de Ziegler. Las dos partes pasaron más de veinte años en los tribunales por las patentes, casi siempre con sentencias favorables a Ziegler.',
    },

    'tu-youyou': {
      work: 'Los parásitos de la malaria se habían hecho resistentes a los medicamentos habituales. En 1969, Tu Youyou quedó al frente del grupo de su instituto dentro del Proyecto 523, una búsqueda china y secreta de uno nuevo. Su equipo probó cientos de extractos de plantas usadas en la medicina tradicional. El ajenjo dulce funcionaba unas veces sí y otras no. Leyendo un manual de recetas de urgencia del siglo IV, se fijó en que decía que había que dejar la planta en agua fría y escurrir el jugo, y no hervirla. Si el calor destruía el compuesto activo, el problema estaba en la extracción. Cambió al éter, que hierve a 35 °C, y en octubre de 1971 obtuvo un extracto que mataba a los parásitos todas las veces.',
      legacy:
