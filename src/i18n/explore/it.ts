...
export const EXPLORE_OVERLAY_IT = {
  molecules: {
    benzene: {
      ...
      chemistry:
        'L’anello è fatto di sei atomi di carbonio disposti in un esagono piatto, ognuno con un idrogeno che sporge all’esterno. La cosa insolita è che sei dei suoi elettroni non appartengono a nessun legame in particolare. Sono distribuiti su tutto l’anello, sopra e sotto il piano dell’esagono. È questa distribuzione che rende il benzene molto meno reattivo di quanto tre legami doppi lascerebbero pensare. Ed è questa che rende i sei legami fra carbonio e carbonio tutti esattamente della stessa lunghezza, invece di alternare tratti corti e tratti lunghi.',
    },

    'citric-acid': {
      name: 'Acido citrico',
      everyday:
        'L’acido citrico è quello che rende aspro un limone: da solo è circa il cinque per cento in peso del succo. È anche la polvere acidula che riveste le caramelle, il pizzicore di una bibita gassata, il principio attivo dell’anticalcare per il bollitore. Si aggiunge anche a quasi ogni cibo in scatola, dove dà sapore e aiuta a evitare che il contenuto si guasti. Quasi tutto l’acido citrico in commercio, però, non viene spremuto da nessun frutto: si ottiene dando zucchero da mangiare a una muffa, che lo produce a tonnellate.',
      chemistry:
    ...
    'silicon-dioxide': {
      ...
      everyday:
        'Il diossido di silicio è la sabbia, è il quarzo ed è gran parte del vetro che ti circonda. Una finestra è fatta per circa il 70 per cento di diossido di silicio, con ossidi di sodio e di calcio mescolati dentro. Servono ad abbassare la temperatura di fusione fino a un valore che un forno riesca davvero a raggiungere. Lo stesso composto sta nella bustina con scritto «non mangiare» che trovi dentro una scatola di scarpe: lì è stato reso poroso, e il suo compito è invece assorbire l’acqua.',
      chemistry:
        'Nel quarzo ogni atomo di silicio è legato a quattro ossigeni e ogni ossigeno fa da ponte fra due atomi di silicio, secondo uno schema che si ripete senza fine. Nel vetro i legami sono gli stessi, ma lo schema non c’è: il reticolo è congelato alla rinfusa. Il liquido si è raffreddato più in fretta di quanto gli atomi riuscissero a mettersi in fila. Questa differenza è tutta la differenza fra un cristallo e un vetro. Vale anche la pena di seppellire una vecchia storia: il vetro non è un liquido che scorre lentamente. I vetri antichi sono più spessi in basso per come sono stati fabbricati, non perché siano colati verso il fondo.',
    },
    ...
    ammonia: {
      ...
      chemistry:
        'L’azoto sta al centro con tre idrogeni intorno e un doppietto di elettroni che avanza. Quel doppietto spinge la molecola a prendere la forma di una piramide schiacciata invece che di un triangolo piatto. È tutta lì la storia. Quel doppietto solitario è libero di afferrare uno ione idrogeno, ed è questo a rendere l’ammoniaca una base; ed è sempre lui a permetterle di formare legami a idrogeno con l’acqua così bene. Nell’industria si costruisce a partire da N2 e H2: l’azoto preso dall’aria, l’idrogeno quasi sempre dal gas naturale, ed è per questo che produrla libera anche moltissimo diossido di carbonio.',
    },
    ...
    'oleic-acid': {
      name: 'Acido oleico',
      everyday:
        'L’acido oleico è il principale acido grasso dell’olio d’oliva: ne è circa tre quarti. È anche gran parte di ciò che si trova nell’olio di colza, nelle mandorle e negli avocado. È la ragione per cui quegli oli restano liquidi in dispensa. La stessa molecola è una parte importante del sebo che produce la tua pelle.',
      chemistry:
    ...
    methane: {
      name: 'Metano',
      everyday:
        'Il metano è il gas naturale. Scalda le case, cuoce il cibo e produce circa un quinto dell’elettricità mondiale. Esce anche dalle zone umide, dalle risaie e dalle discariche, e lo emettono le mucche. È un gas serra molto più potente del diossido di carbonio. Si decompone però nell’atmosfera nel giro di una decina d’anni, cosa che il diossido di carbonio non fa.',
      chemistry:
    ...
    water: {
      everyday:
        'L’acqua ricopre la maggior parte del pianeta, costituisce circa il 60 per cento di te. È l’unica sostanza comune che ti capita di incontrare come solido, come liquido e come gas nello stesso giorno. È anche la ragione per cui uno stagno gela a partire dalla superficie: l’acqua solida è meno densa dell’acqua liquida, una stranezza che in natura è quasi unica.',
      chemistry:
    ...
    'lithium-cobalt-oxide': {
      ...
      everyday:
        'L’ossido di litio e cobalto è l’elettrodo positivo di moltissime batterie di telefoni e computer portatili. Non lo vedrai mai: è una polvere nera, stesa su un foglio di alluminio e arrotolata dentro la cella. Il cobalto che contiene è il motivo per cui chi produce batterie continua a cercare di usarne di meno. Circa tre quarti del cobalto mondiale si estrae nella Repubblica Democratica del Congo. Una parte viene da piccole miniere non controllate, con problemi reali di sicurezza e di lavoro minorile.',
      chemistry:
  ...
  scientists: {
    ...
    'vladimir-prelog': {
      ...
      legacy:
        'Sono le regole di Cahn–Ingold–Prelog. È grazie a loro che una R o una S dentro il nome di una sostanza vogliono dire la stessa cosa in ogni laboratorio e in ogni lingua. La cosa conta, perché due forme speculari di uno stesso farmaco possono comportarsi in modo completamente diverso dentro un corpo. Prelog era nato a Sarajevo, era cresciuto a Zagabria, fuggì a Zurigo nel 1941 e divise il premio Nobel del 1975 con John Cornforth.',
    },
    ...
    'giulio-natta': {
      work: 'Le molecole di propene si uniscono volentieri in catene lunghe. Ma se si uniscono rivolte ognuna come le pare la catena è un groviglio, con i gruppi metilici che sporgono da tutte e due le parti. La plastica è molle e debole. L’11 marzo 1954, al Politecnico di Milano, Giulio Natta ottenne una catena in cui ogni gruppo metilico punta dalla stessa parte. Usò un catalizzatore del tipo che aveva messo a punto Karl Ziegler, capace di tenere ferma ogni molecola in arrivo in un orientamento fisso finché non si è attaccata. Quella disposizione regolare Natta la chiamò isotattica. Le catene regolari possono impacchettarsi strette una contro l’altra e allinearsi in cristalli; quelle aggrovigliate no.',
      legacy:
    ...
    'dan-shechtman': {
      work: 'I cristalli si ripetono. Non era un’ipotesi, era la definizione: gli atomi stanno in uno schema che si ricopia da sé all’infinito in tutte le direzioni. Uno schema così non può avere una simmetria a cinque o a dieci punte. Non puoi piastrellare un pavimento con dei pentagoni senza lasciare buchi. L’8 aprile 1982 Dan Shechtman era distaccato dal Technion di Haifa presso un laboratorio del governo statunitense. Sparò degli elettroni attraverso una lega di alluminio e manganese raffreddata rapidamente, e ottenne una figura di diffrazione con una simmetria a dieci punte. L’appunto sul suo quaderno, per quel campione, dice «10 fold ???». Gli atomi erano ordinati alla perfezione – potevi dire dove sarebbe andato il successivo – ma la disposizione non si ripeteva mai.',
      legacy:
