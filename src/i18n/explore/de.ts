...
export const EXPLORE_OVERLAY_DE = {
  molecules: {
    ...
    'citric-acid': {
      name: 'Citronensäure',
      everyday:
        'Citronensäure ist das, was eine Zitrone so sauer macht – etwa fünf Prozent des Zitronensafts bestehen daraus. Sie ist außerdem der saure Überzug auf Bonbons, der Kick in einer Limonade und der Wirkstoff im Entkalker. Sie steckt auch in fast jeder Konserve, wo sie würzt und den Inhalt länger haltbar macht. Das meiste, was verkauft wird, ist gar nicht aus Früchten gepresst. Es entsteht, indem man einen Schimmelpilz mit Zucker füttert – der produziert es tonnenweise.',
      chemistry:
    ...
    'lithium-cobalt-oxide': {
      ...
      everyday:
        'Lithiumcobaltoxid ist die positive Elektrode in sehr vielen Handy- und Laptop-Akkus. Zu sehen bekommst du es nie: Es ist ein schwarzes Pulver, auf Aluminiumfolie gestrichen und in der Zelle aufgerollt. Das Cobalt darin ist der Grund, warum die Hersteller immer weniger davon verwenden wollen. Rund drei Viertel des weltweiten Cobalts werden in der Demokratischen Republik Kongo abgebaut. Ein Teil davon kommt aus kleinen, unkontrollierten Minen mit echten Problemen bei Sicherheit und Kinderarbeit.',
      chemistry:
    ...
    polypropylene: {
      ...
      chemistry:
        'Die Formel oben ist die sich wiederholende Einheit, und sie ist dieselbe wie die von Propen. Beim Bilden der Ketten kommt nichts dazu und geht nichts verloren: Jedes Molekül öffnet einfach seine Doppelbindung und hängt sich an. Ob der Kunststoff etwas taugt, entscheidet sich daran, wohin jede Methylgruppe am Ende zeigt. Mit einem gewöhnlichen Katalysator hergestellt, sind die Ketten ein Knäuel, und der Kunststoff ist weich und schwach. Mit einem Ziegler-Natta-Katalysator hergestellt, zeigt jede Methylgruppe in dieselbe Richtung, die Ketten winden sich zu regelmäßigen Schrauben, und die packen sich zu kristallinen Bereichen zusammen. Diese Regelmäßigkeit ist der Unterschied zwischen einem klebrigen Gummi und einer Stoßstange.',
    },
    ...
    'sodium-chloride': {
      ...
      chemistry:
        'In einem Salzkorn gibt es keine Natriumchlorid-Moleküle. Der Kristall besteht aus Natrium-Ionen und Chlorid-Ionen, die sich in jede Richtung abwechseln. Jedes Natrium ist von sechs Chloriden umgeben und jedes Chlorid von sechs Natrium-Ionen, und das wiederholt sich milliardenfach in einer Reihe. Die Formel ist eine Verhältnisformel, eins zu eins, und keine Anzahl von Atomen in einem Molekül. Dieses endlos wiederholte Muster macht es zu einem Kristall. Deshalb zerspringt ein Korn in kleine Würfel: Du trennst es entlang von Ebenen, auf denen die Ionen ohnehin schon aufgereiht waren.',
    },
  },
  ...
  scientists: {
    ...
    'paul-sabatier': {
      ...
      credit: 'Senderens, der die Versuche von 1897 mit ihm gemacht hat, ging bei diesem Preis leer aus. Diese Auslassung bringt die Chemie bis heute für ihn zur Sprache.',
    },
    ...
    'giulio-natta': {
      ...
      credit: 'Ziegler war über das Teilen nicht erfreut. Natta war über Zieglers Katalysatorchemie zu der Reaktion gekommen. Die beiden Seiten stritten mehr als zwanzig Jahre lang vor Gericht um die Patente – meist mit dem besseren Ende für Ziegler.',
    },

    'tu-youyou': {
      work: 'Malariaparasiten waren gegen die üblichen Medikamente resistent geworden. 1969 bekam Tu Youyou die Leitung der Gruppe ihres Instituts innerhalb von Projekt 523, einer geheimen chinesischen Suche nach einem neuen Mittel. Ihr Team prüfte Hunderte Pflanzenauszüge aus der traditionellen Medizin. Einjähriger Beifuß wirkte mal und mal nicht. Beim Lesen eines Handbuchs mit Notfallrezepten aus dem 4. Jahrhundert fiel ihr eine Anweisung auf. Man solle die Pflanze in kaltem Wasser einweichen und den Saft auswringen – nicht kochen. Wenn Hitze den Wirkstoff zerstörte, dann lag das Problem im Auszugsverfahren. Sie stieg auf Ether um, der schon bei 35 °C siedet, und bekam im Oktober 1971 einen Auszug, der die Parasiten jedes Mal abtötete.',
    ...
    'dan-shechtman': {
      work: 'Kristalle wiederholen sich. Das war keine Vermutung, das war die Definition: Die Atome sitzen in einem Muster, das sich in jede Richtung immer wieder selbst kopiert. Ein solches Muster kann keine fünf- oder zehnzählige Symmetrie haben. Einen Boden kann man mit Fünfecken nicht lückenlos auslegen. Am 8. April 1982 war Dan Shechtman von der Technion in Haifa an ein US-Regierungslabor abgeordnet. Er schoss Elektronen durch eine schnell abgekühlte Aluminium-Mangan-Legierung und bekam ein Beugungsmuster mit zehnzähliger Symmetrie. Sein Laborbuch hält zu dieser Probe fest: „10 fold ???“. Die Atome waren perfekt geordnet – man konnte sagen, wohin das nächste gehört –, aber die Anordnung wiederholte sich nie.',
