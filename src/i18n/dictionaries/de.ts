...
export const de = {
  meta: {
    ...
    title: 'Games in Chemistry | Chemie interaktiv lernen',
    description:
    ...
    privacyTitle: 'Datenschutz | Games in Chemistry',
    privacyDescription:
      'Was Games in Chemistry über dich speichert, was öffentlich ist, wer die Daten verarbeitet und wie du sie herunterlädst oder löschst.',
    teachersTitle: 'Für Lehrkräfte | Games in Chemistry',
    teachersDescription:
      'Was Games in Chemistry ist, in welchen sechs Sprachen es erscheint, wie es mit den Daten von Lernenden umgeht, wo die Barrierefreiheit steht und wie Lehrkräfte die Beta mitgestalten können.',
    cheatSheetTitle: 'Spickzettel {title} | Games in Chemistry',
    cheatSheetNotFound: 'Thema nicht gefunden – Games in Chemistry',
    exploreEntryNotFound: 'Eintrag nicht gefunden – Games in Chemistry',
  },
  ...
  footer: {
    tagline: 'Games in Chemistry – Chemie sichtbar, spielerisch und verständlich.',
    copyright: '© {year} Games in Chemistry. Alle Rechte vorbehalten.',
    privacy: 'Datenschutz',
  ...
  auth: {
    ...
    registerTitle: 'Bei Games in Chemistry mitmachen',
    ...
    switchToRegisterPrompt: 'Neu bei Games in Chemistry?',
    switchToRegisterAction: 'Registrieren',
    switchToLoginPrompt: 'Du hast schon ein Konto?',
    switchToLoginAction: 'Anmelden',
    checkInbox: 'Schau in dein Postfach, um dein Konto zu aktivieren.',
  ...
  profile: {
    ...
    dataIntro:
      'Lade eine Kopie der Daten herunter, die Games in Chemistry über dich speichert, oder lösche dein Konto.',
  ...
  privacy: {
    heading: 'Datenschutz',
    intro:
      'Was Games in Chemistry über dich speichert, wer es sehen kann und wie du es herunterlädst oder löschst.',
    effectiveDate: 'Gültig ab: {date}.',

    whoWeAreHeading: 'Wer wir sind',
    whoWeAreBody:
      'Games in Chemistry wird von Stella Slad betrieben. Sie ist für die auf dieser Seite beschriebenen Daten verantwortlich. Du erreichst uns unter {email}.',
    ...
    childrenBody1:
      'Games in Chemistry ist für die Sekundarstufe gemacht. Deshalb erheben wir nur das Nötigste, um die Spiele zu betreiben und Punkte zu speichern.',
    childrenBody2:
  ...
  feedback: {
    ...
    trigger: 'Feedback',
    heading: 'Feedback zu Games in Chemistry',
    closeA11y: 'Feedback schließen',
    sentTitle: 'Feedback gesendet!',
    sentBody: 'Danke, dass du hilfst, Games in Chemistry besser zu machen.',
    categoryBug: 'Fehler',
  ...
  periodicTable: {
    caption: 'Das Periodensystem – alle 118 Elemente, nach Ordnungszahl geordnet',
    modeLabel: 'Tabelle einfärben nach',
    legendHeading: 'Legende',
    scrollHint:
      'Die Tabelle ist breiter als ein Handybildschirm und lässt sich deshalb für sich allein seitlich schieben. Gruppe 1 steht links, Gruppe 18 rechts.',
    keyboardHint:
      'Mit den Pfeiltasten gehst du von Element zu Element. Pos1 und Ende springen an die Enden einer Periode, Bild-auf und Bild-ab an die Enden einer Gruppe, und Eingabe oder Leertaste öffnet ein Element.',
    cellA11y: '{name}, Symbol {symbol}, Ordnungszahl {n}, Gruppe {group}, Periode {period}',
    cellA11yFBlock: '{name}, Symbol {symbol}, Ordnungszahl {n}, {family}, Periode {period}',
    groupHeaderA11y: 'Gruppe {group}',
    periodHeaderA11y: 'Periode {period}',
    detailHeading: 'Ausgewähltes Element',
    previous: 'Vorheriges Element',
    next: 'Nächstes Element',
    fullTableLink: 'Alle sechs Ansichten der Tabelle stehen auf dem Spickzettel für Klasse 9',
    reactivityNote:
      'Die Reaktivität wird nur innerhalb einer Gruppe verglichen. Eine 3 in Gruppe 1 und eine 3 in Gruppe 17 stehen nicht für dieselbe Reaktion.',
    sizeNote: 'Jede Marke ist der Radius dieses Atoms in Pikometern.',
    modes: {
      metals: 'Metalle und Nichtmetalle',
      families: 'Familien',
      outerShell: 'Äußerste Stufe',
      atomicSize: 'Atomgröße',
      reactivity: 'Reaktivität',
      ionFormed: 'Gebildetes Ion',
      occurrence: 'Natürlich oder gemacht',
    },
    badge: {
      metal: 'M',
      nonMetal: 'NM',
    ...
    legend: {
      ...
      metalloid: 'Halbmetall – verhält sich teils wie das eine, teils wie das andere (Erweiterung)',
      'alkali-metal': 'Alkalimetall',
      'alkaline-earth': 'Erdalkalimetall',
      'transition-metal': 'Übergangsmetall',
      lanthanide: 'Lanthanoid',
      actinide: 'Actinoid',
      'post-transition-metal': 'Anderes Metall',
      'other-non-metal': 'Anderes Nichtmetall',
      halogen: 'Halogen',
      'noble-gas': 'Edelgas',
      'outer-count': 'Elektronen auf der äußersten Stufe: {n}',
      'outer-none':
        'Auf dieser Stufe keine einfache Zahl – bei den Übergangsmetallen und den beiden unteren Reihen wird eine innere Stufe aufgefüllt, deshalb gibt es keine einzelne äußere Zahl.',
      'size-smallest': 'Am kleinsten – unter 100 pm',
      'size-small': 'Klein – 100 bis 150 pm',
      'size-medium': 'Mittel – 150 bis 200 pm',
      'size-large': 'Groß – 200 bis 250 pm',
      'size-largest': 'Am größten – über 250 pm',
      'reactivity-unreactive': '0 – reagiert mit fast nichts',
      'reactivity-low': '1 – reagiert langsam',
      'reactivity-moderate': '2 – reagiert stetig',
      'reactivity-high': '3 – reagiert schnell',
      'reactivity-very-high': '4 – reagiert heftig',
      'reactivity-none':
        'Nicht eingestuft – so einfach ist die Reaktivität nur in den Gruppen 1, 2, 17 und 18',
      'ion-positive': 'Gibt Elektronen ab und bildet ein positives Ion',
      'ion-negative': 'Nimmt Elektronen auf und bildet ein negatives Ion',
      'ion-none':
        'Kein einzelnes Ion – die Edelgase bilden keines, und ein Übergangsmetall bildet mehrere',
      natural: 'Kommt in der Natur vor',
      synthetic: 'Im Labor hergestellt',
    },
    fields: {
      symbol: 'Symbol',
      atomicNumber: 'Ordnungszahl',
      mass: 'Relative Atommasse',
      arrangement: 'Elektronenverteilung',
      group: 'Gruppe',
      period: 'Periode',
      metalClass: 'Metall oder Nichtmetall',
      family: 'Familie',
      ion: 'Gebildetes Ion',
      occurrence: 'Natürlich oder gemacht',
    },
    values: {
      fBlockGroup: 'Außerhalb der nummerierten Gruppen',
    },
  },
