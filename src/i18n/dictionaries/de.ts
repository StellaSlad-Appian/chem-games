...
export const de = {
  ...
  gamesHub: {
    ...
    balancerDescription:
      'Passe die stöchiometrischen Koeffizienten an, um Gleichungen auszugleichen.',
  ...
  games: {
    ...
    reactionBalancer: {
      subtitle: 'ZIEL: Passe die Koeffizienten an, bis beide Seiten gleich viele Atome haben',
      progress: 'Level {level}',
      instructionsTitle: 'Spielanleitung: Reaktions-Balancer',
      instructionsBody:
        'Stelle mit den Pfeilen {arrows} über jeder Verbindung ihren stöchiometrischen Koeffizienten so ein, dass von jedem Element auf beiden Seiten des Reaktionspfeils gleich viele Atome stehen.',
      prompt: 'Ändere die Koeffizienten, bis jedes Atom erhalten bleibt.',
      reactants: 'Edukte',
      products: 'Produkte',
      checkAnswer: 'Antwort prüfen',
      editableHint: 'Du kannst deine Koeffizienten jederzeit ändern.',
      showAtomBalance: 'Atombilanz anzeigen',
      hideAtomBalance: 'Atombilanz ausblenden',
      atomBalance: 'Atombilanz',
      scaleHint: 'Die Waage neigt sich zur Seite mit mehr Atomen.',
      balanced: 'Alle Atome sind ausgeglichen',
      molecules: 'Moleküle',
      moleculeView: 'Molekülansicht',
      coefficientA11y: 'Koeffizient für {formula}',
      atomBalanceA11y:
        '{element}: {left} Atome auf der Eduktseite und {right} Atome auf der Produktseite',
      moleculeA11y: 'Molekül {formula}',
      particleCountOneA11y: '{count} Molekül {formula}',
      particleCountOtherA11y: '{count} Moleküle {formula}',
    },
  },
