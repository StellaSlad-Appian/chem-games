...
export const ru = {
  ...
  privacy: {
    ...
    cookiesBody1:
      'При входе Supabase ставит куки сессии. Они строго необходимы, чтобы ты оставался в аккаунте.',
    cookiesBody2:
      'Ещё мы ставим одну куку с настройкой — она помнит выбранный язык, чтобы сайт открылся на нём в следующий раз. В ней нет ничего, кроме кода языка.',
    cookiesBody3:
      'В локальном хранилище браузера лежат настройки звука, темы и отметка «инструкцию уже видел». Эти данные остаются на твоём устройстве и нам не передаются.',
