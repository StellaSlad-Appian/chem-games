...
export const it = {
  ...
  periodicTable: {
    caption: 'La tavola periodica: tutti i 118 elementi, ordinati per numero atomico',
    modeLabel: 'Colora la tavola in base a',
    legendHeading: 'Legenda',
    scrollHint:
      'La tavola è più larga dello schermo di un telefono, quindi scorre di lato per conto suo. Il gruppo 1 sta a sinistra e il gruppo 18 a destra.',
    keyboardHint:
      'Le frecce spostano da un elemento all’altro. Inizio e Fine portano agli estremi di un periodo, Pag su e Pag giù agli estremi di un gruppo, e Invio o Spazio apre un elemento.',
    cellA11y: '{name}, simbolo {symbol}, numero atomico {n}, gruppo {group}, periodo {period}',
    cellA11yFBlock: '{name}, simbolo {symbol}, numero atomico {n}, {family}, periodo {period}',
    groupHeaderA11y: 'Gruppo {group}',
    periodHeaderA11y: 'Periodo {period}',
    detailHeading: 'Elemento selezionato',
    previous: 'Elemento precedente',
    next: 'Elemento successivo',
    fullTableLink: 'Tutte e sei le viste della tavola sono sulla scheda del terzo anno',
    reactivityNote:
      'La reattività si confronta solo all’interno di uno stesso gruppo. Un 3 del gruppo 1 e un 3 del gruppo 17 non descrivono la stessa reazione.',
    sizeNote: 'Ogni contrassegno è il raggio di quell’atomo in picometri.',
    modes: {
      metals: 'Metalli e non metalli',
      families: 'Famiglie',
      outerShell: 'Guscio esterno',
      atomicSize: 'Dimensione dell’atomo',
      reactivity: 'Reattività',
      ionFormed: 'Ione formato',
      occurrence: 'Naturale o prodotto',
    },
    badge: {
      metal: 'M',
      nonMetal: 'NM',
    ...
    legend: {
      ...
      metalloid:
        'Semimetallo: si comporta in parte come l’uno e in parte come l’altro (approfondimento)',
      'alkali-metal': 'Metallo alcalino',
      'alkaline-earth': 'Metallo alcalino terroso',
      'transition-metal': 'Metallo di transizione',
      lanthanide: 'Lantanide',
      actinide: 'Attinide',
      'post-transition-metal': 'Altro metallo',
      'other-non-metal': 'Altro non metallo',
      halogen: 'Alogeno',
      'noble-gas': 'Gas nobile',
      'outer-count': 'Elettroni sul guscio esterno: {n}',
      'outer-none':
        'A questo livello non è un conteggio semplice: nei metalli di transizione e nelle due righe in basso si riempie un guscio interno, quindi non c’è un unico numero esterno da dare.',
      'size-smallest': 'I più piccoli: sotto i 100 pm',
      'size-small': 'Piccoli: da 100 a 150 pm',
      'size-medium': 'Medi: da 150 a 200 pm',
      'size-large': 'Grandi: da 200 a 250 pm',
      'size-largest': 'I più grandi: oltre 250 pm',
      'reactivity-unreactive': '0: non reagisce quasi con nulla',
      'reactivity-low': '1: reagisce lentamente',
      'reactivity-moderate': '2: reagisce in modo costante',
      'reactivity-high': '3: reagisce in fretta',
      'reactivity-very-high': '4: reagisce con violenza',
      'reactivity-none':
        'Non classificata: la reattività è così semplice solo nei gruppi 1, 2, 17 e 18',
      'ion-positive': 'Perde elettroni e forma uno ione positivo',
      'ion-negative': 'Acquista elettroni e forma uno ione negativo',
      'ion-none':
        'Nessuno ione unico: i gas nobili non ne formano, e un metallo di transizione ne forma più di uno',
      natural: 'Si trova in natura',
      synthetic: 'Prodotto in laboratorio',
    },
    fields: {
      symbol: 'Simbolo',
      atomicNumber: 'Numero atomico',
      mass: 'Massa atomica relativa',
      arrangement: 'Distribuzione degli elettroni',
      group: 'Gruppo',
      period: 'Periodo',
      metalClass: 'Metallo o non metallo',
      family: 'Famiglia',
      ion: 'Ione formato',
      occurrence: 'Naturale o prodotto',
    },
    values: {
      fBlockGroup: 'Fuori dai gruppi numerati',
    },
  },
