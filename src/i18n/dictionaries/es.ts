...
export const es = {
  meta: {
    ...
    title: 'Games in Chemistry | Aprende química jugando',
    description:
    ...
    privacyTitle: 'Privacidad | Games in Chemistry',
    privacyDescription:
      'Qué guarda Games in Chemistry sobre ti, qué es público, quién lo trata y cómo descargar o borrar tus datos.',
    teachersTitle: 'Para el profesorado | Games in Chemistry',
    teachersDescription:
      'Qué es Games in Chemistry, en qué seis idiomas existe, cómo trata los datos del alumnado, en qué punto está la accesibilidad y cómo el profesorado puede ayudar a darle forma durante la beta.',
    cheatSheetTitle: 'Chuleta de {title} | Games in Chemistry',
    cheatSheetNotFound: 'Tema no encontrado – Games in Chemistry',
    exploreEntryNotFound: 'Ficha no encontrada – Games in Chemistry',
  },
  ...
  footer: {
    tagline: 'Games in Chemistry – la química en imágenes, jugando y sin líos.',
    copyright: '© {year} Games in Chemistry. Todos los derechos reservados.',
    privacy: 'Privacidad',
  ...
  home: {
    ...
    heroHook: 'Gratis. Sin registro. Abre un juego y empieza.',
  ...
  gamesHub: {
    ...
    searchPlaceholder: 'Busca juegos y conceptos',
    filterA11y: 'Filtrar los juegos por curso',
    noResultsTitle: 'Ningún juego coincide.',
    noResultsBody: 'Prueba con otro curso o con otra palabra.',
  ...
  auth: {
    ...
    registerTitle: 'Únete a Games in Chemistry',
    ...
    switchToRegisterPrompt: '¿Es tu primera vez en Games in Chemistry?',
    switchToRegisterAction: 'Registrarse',
    switchToLoginPrompt: '¿Ya tienes una cuenta?',
    switchToLoginAction: 'Iniciar sesión',
    checkInbox: 'Mira en tu correo para activar tu cuenta de Games in Chemistry.',
  ...
  profile: {
    ...
    dataIntro: 'Descarga una copia de lo que Games in Chemistry guarda sobre ti, o borra tu cuenta.',
  ...
  privacy: {
    heading: 'Privacidad',
    intro: 'Qué guarda Games in Chemistry sobre ti, quién puede verlo y cómo descargarlo o borrarlo.',
    effectiveDate: 'En vigor desde el {date}.',

    whoWeAreHeading: 'Quiénes somos',
    whoWeAreBody:
      'Games in Chemistry lo gestiona Stella Slad, responsable de los datos que se describen en esta página. Puedes escribirnos a {email}.',
    ...
    childrenBody1:
      'Games in Chemistry está pensado para la educación secundaria, así que recogemos lo mínimo necesario para que los juegos funcionen y para guardar las puntuaciones.',
    childrenBody2:
  ...
  feedback: {
    ...
    trigger: 'Comentarios',
    heading: 'Comentarios sobre Games in Chemistry',
    closeA11y: 'Cerrar los comentarios',
    sentTitle: '¡Comentario enviado!',
    sentBody: 'Gracias por ayudarnos a mejorar Games in Chemistry.',
  ...
  periodicTable: {
    caption: 'La tabla periódica: los 118 elementos, ordenados por número atómico',
    modeLabel: 'Colorear la tabla según',
    legendHeading: 'Leyenda',
    scrollHint:
      'La tabla es más ancha que la pantalla de un móvil, así que se desplaza de lado por su cuenta. El grupo 1 queda a la izquierda y el 18 a la derecha.',
    keyboardHint:
      'Las flechas mueven de un elemento a otro. Inicio y Fin llevan a los extremos de un periodo, Re Pág y Av Pág a los extremos de un grupo, e Intro o Espacio abre un elemento.',
    cellA11y: '{name}, símbolo {symbol}, número atómico {n}, grupo {group}, periodo {period}',
    cellA11yFBlock: '{name}, símbolo {symbol}, número atómico {n}, {family}, periodo {period}',
    groupHeaderA11y: 'Grupo {group}',
    periodHeaderA11y: 'Periodo {period}',
    detailHeading: 'Elemento seleccionado',
    previous: 'Elemento anterior',
    next: 'Elemento siguiente',
    fullTableLink: 'Las seis vistas de la tabla están en la ficha de 3.º de ESO',
    reactivityNote:
      'La reactividad solo se compara dentro de un mismo grupo. Un 3 del grupo 1 y un 3 del grupo 17 no describen la misma reacción.',
    sizeNote: 'Cada distintivo es el radio de ese átomo en picómetros.',
    modes: {
      metals: 'Metales y no metales',
      families: 'Familias',
      outerShell: 'Capa externa',
      atomicSize: 'Tamaño del átomo',
      reactivity: 'Reactividad',
      ionFormed: 'Ion que forma',
      occurrence: 'Natural o fabricado',
    },
    badge: {
      metal: 'M',
      nonMetal: 'NM',
    ...
    legend: {
      metal: 'Metal',
      'non-metal': 'No metal',
      metalloid: 'Metaloide: se comporta en parte como uno y en parte como otro (ampliación)',
      'alkali-metal': 'Metal alcalino',
      'alkaline-earth': 'Metal alcalinotérreo',
      'transition-metal': 'Metal de transición',
      lanthanide: 'Lantánido',
      actinide: 'Actínido',
      'post-transition-metal': 'Otro metal',
      'other-non-metal': 'Otro no metal',
      halogen: 'Halógeno',
      'noble-gas': 'Gas noble',
      'outer-count': 'Electrones en la capa externa: {n}',
      'outer-none':
        'A este nivel no es un recuento sencillo: en los metales de transición y en las dos filas inferiores se llena una capa interna, así que no hay un único número externo que dar.',
      'size-smallest': 'Los más pequeños: menos de 100 pm',
      'size-small': 'Pequeños: de 100 a 150 pm',
      'size-medium': 'Medianos: de 150 a 200 pm',
      'size-large': 'Grandes: de 200 a 250 pm',
      'size-largest': 'Los más grandes: más de 250 pm',
      'reactivity-unreactive': '0: no reacciona casi con nada',
      'reactivity-low': '1: reacciona despacio',
      'reactivity-moderate': '2: reacciona de forma constante',
      'reactivity-high': '3: reacciona deprisa',
      'reactivity-very-high': '4: reacciona con violencia',
      'reactivity-none':
        'Sin graduar: la reactividad solo es así de sencilla en los grupos 1, 2, 17 y 18',
      'ion-positive': 'Pierde electrones y forma un ion positivo',
      'ion-negative': 'Gana electrones y forma un ion negativo',
      'ion-none':
        'Ningún ion único: los gases nobles no forman ninguno y un metal de transición forma varios',
      natural: 'Se encuentra en la naturaleza',
      synthetic: 'Fabricado en un laboratorio',
    },
    fields: {
      symbol: 'Símbolo',
      atomicNumber: 'Número atómico',
      mass: 'Masa atómica relativa',
      arrangement: 'Distribución electrónica',
      group: 'Grupo',
      period: 'Periodo',
      metalClass: 'Metal o no metal',
      family: 'Familia',
      ion: 'Ion que forma',
      occurrence: 'Natural o fabricado',
    },
    values: {
      fBlockGroup: 'Fuera de los grupos numerados',
    },
  },
