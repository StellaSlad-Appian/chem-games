...
//
// «Electrón desapareado» es el único nombre que el juego da a un electrón
// externo sin pareja: en todas partes, también sobre la zona de dibujo. La
// palabra del juego «impar» se retiró el 19/09/2026.
//
// Sigue en pie el aviso de colisión que en su día decidió aquella palabra: el
// español llama *par solitario* a un lone pair, así que *solitario* no puede
// nombrar nunca a un electrón suelto en este juego — las dos frases se
// diferencian en una palabra y quieren decir cosas opuestas. El razonamiento
// completo, y los candidatos descartados (libre, suelto, soltero,
// desparejado), están en docs/i18n/glossary-es.md.
//
...
export const es = {
  ...
  instructions: {
    ...
    lead: 'Empareja los electrones desapareados.',
    intro:
      'Cada átomo trae sus electrones externos en forma de puntos. Un punto que está solo es un electrón desapareado: busca pareja. Dos electrones desapareados de dos átomos distintos forman un par enlazante, es decir, un enlace.',
    bullets: [
      ...
      'La estructura se bloquea sola cuando cada átomo está completo y no queda ningún electrón desapareado. No hace falta ningún botón.',
    ...
    keyboard: [
      ...
      ['← →', 'pasan de un electrón desapareado a otro'],
  ...
  guided: {
    ...
    h2: [
      'Dos átomos de hidrógeno. Cada uno tiene 1 electrón externo: un electrón desapareado. Arrastra uno sobre el otro.',
      'Ahora comparten un par. Cuenta alrededor de cada H: 2. El hidrógeno está completo con 2, así que es un enlace simple, H–H.',
    ],
    h2oStep1:
      'El oxígeno tiene 6 electrones externos: dos pares (que se quedan quietos) y dos electrones desapareados (que parpadean).',
    h2oStep2: 'Empareja un electrón desapareado del oxígeno con uno del hidrógeno.',
    h2oStep2After: 'El oxígeno tiene ya 7 alrededor; le falta uno.',
    h2oStep3: 'Empareja el otro electrón desapareado del oxígeno con el otro hidrógeno.',
    h2oStep4:
  ...
  coach: {
    label: 'Guía',
    loners: {
      one: '{atom}: queda {count} electrón desapareado. Se empareja con un electrón desapareado de otro átomo.',
      other:
        '{atom}: quedan {count} electrones desapareados. Se emparejan con electrones desapareados de otro átomo.',
    },
    needsMore:
      '{atom}: {count} de 8. Le falta otro par enlazante. ¿Qué átomo tiene todavía un electrón desapareado?',
    shareAgain:
      '{atom1} y {atom2} tienen los dos un electrón desapareado. Pueden compartir otra vez: eso hace un enlace doble.',
    complete:
      'Cada átomo está completo y no queda ningún electrón desapareado. Molécula obtenida: {name} – {bonds}, {lonePairs}.',
    sameGroup:
    ...
    central: 'El átomo que tiene más electrones desapareados suele ir en el centro.',
    deadEnd:
      '{atom}: {count} de 8, pero ningún otro átomo tiene un electrón desapareado que compartir. Toca un par enlazante para deshacerlo y prueba con otra pareja.',
    isomer:
  ...
  hint: {
    ...
    tier3: 'Empareja dos electrones desapareados, uno en cada átomo: {atom1} y {atom2}.',
    ...
    inspectTier3Repair:
      'Empareja los electrones desapareados hasta que cada átomo vuelva a estar completo.',
  ...
  error: {
    ...
    atomFull:
      '{atom}: ya tiene 8. Ese átomo no puede compartir nada más. Busca otro que tenga todavía un electrón desapareado.',
    ...
    pairedDot:
      'Ese punto ya forma parte de un par. Solo se pueden compartir los electrones desapareados, los que parpadean.',
  },
  ...
  inspect: {
    ...
    explainNeedsDouble:
      '{atom1} y {atom2} tienen todavía un electrón desapareado cada uno: tienen que compartir dos veces.',
    explainLeftover: '{atom}: ha quedado un electrón desapareado. Se ha dibujado un electrón de más.',
    ...
    repair:
      'Ahora corrígelo: empareja los electrones desapareados hasta que cada átomo esté completo.',
  ...
  overlay: {
    ...
    levelUpSubtitle: 'No queda ningún electrón desapareado',
    ...
    victorySubtitle: 'No queda ningún electrón desapareado',
  ...
  glossary: {
    ...
    unpairedElectron: {
      term: 'electrón desapareado',
      definition: 'un electrón externo sin pareja; solo esos se pueden compartir',
      matches: [
  ...
  ui: {
    ...
    atomLonerA11y: '{element}, electrón desapareado {index} de {total}',
    ...
    unpairedLabel: 'electrón desapareado',
    atomFull: 'completo',
    atomSelectedA11y:
      '{element}: electrón desapareado seleccionado. Elige ahora un electrón desapareado de otro átomo.',
