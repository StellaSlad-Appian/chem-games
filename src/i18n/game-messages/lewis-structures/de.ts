...
//
// Teilen bis voll (Lewis-Formeln) auf Deutsch. „Ungepaartes Elektron“ ist der
// einzige Name für ein Außenelektron ohne Partner – überall, auch auf der
// Zeichenfläche. Das frühere Spielwort „Einzelelektron“ (englisch „loner“)
// wurde am 19.09.2026 gestrichen; warum, steht in docs/i18n/glossary-de.md.
// Fachbegriffe sonst nach docs/i18n/glossary-de.md: Lewis-Formel,
...
export const de = {
  ...
  instructions: {
    ...
    lead: 'Bring die ungepaarten Elektronen zu Paaren zusammen.',
    intro:
      'Jedes Atom bringt seine Außenelektronen als Punkte mit. Ein Punkt, der allein steht, ist ein ungepaartes Elektron – es sucht einen Partner. Zwei ungepaarte Elektronen von zwei verschiedenen Atomen ergeben ein bindendes Elektronenpaar, also eine Bindung.',
    bullets: [
      ...
      'Die Formel rastet von selbst ein, sobald jedes Atom voll ist und kein ungepaartes Elektron mehr übrig ist. Du brauchst keinen Knopf.',
    ...
    keyboard: [
      ...
      ['← →', 'gehen zu seinen ungepaarten Elektronen'],
  ...
  guided: {
    ...
    h2: [
      'Zwei Wasserstoffatome. Jedes hat 1 Außenelektron – ein ungepaartes Elektron. Zieh den einen auf den anderen.',
      'Jetzt teilen sie sich ein Paar. Zähl um jedes H herum: 2. Wasserstoff ist bei 2 voll – das ist eine Einfachbindung, H–H.',
    ],
    h2oStep1:
      'Sauerstoff hat 6 Außenelektronen: zwei Paare (die bleiben, wo sie sind) und zwei ungepaarte Elektronen (die pulsieren).',
    h2oStep2:
      'Bring ein ungepaartes Elektron des Sauerstoffs mit einem ungepaarten Elektron des Wasserstoffs zusammen.',
    h2oStep2After: 'Um den Sauerstoff stehen jetzt 7 – eines fehlt noch.',
    h2oStep3:
      'Bring das andere ungepaarte Elektron des Sauerstoffs mit dem anderen Wasserstoff zusammen.',
    h2oStep4:
  ...
  coach: {
    label: 'Coach',
    loners: {
      one: '{atom} hat noch {count} ungepaartes Elektron. Es paart sich mit einem ungepaarten Elektron an einem anderen Atom.',
      other:
        '{atom} hat noch {count} ungepaarte Elektronen. Sie paaren sich mit ungepaarten Elektronen an einem anderen Atom.',
    },
    needsMore:
      '{atom} hat {count} von 8. Es braucht noch ein bindendes Elektronenpaar – welches Atom hat noch ein ungepaartes Elektron?',
    shareAgain:
      '{atom1} und {atom2} haben beide noch ein ungepaartes Elektron. Sie können noch einmal teilen – das ergibt eine Doppelbindung.',
    complete:
      'Jedes Atom ist voll und kein ungepaartes Elektron ist übrig. Das ist {name}: {bonds}, {lonePairs}.',
    sameGroup:
    ...
    central: 'Das Atom mit den meisten ungepaarten Elektronen steht meistens in der Mitte.',
    deadEnd:
      '{atom} hat {count} von 8, aber kein anderes Atom hat noch ein ungepaartes Elektron zum Teilen. Tipp auf ein bindendes Elektronenpaar, um es zu lösen, und versuch es mit einem anderen Partner.',
    isomer:
  ...
  hint: {
    ...
    tier3:
      'Bring das ungepaarte Elektron an {atom1} mit dem ungepaarten Elektron an {atom2} zusammen.',
    ...
    inspectTier3Repair:
      'Bring die ungepaarten Elektronen zu Paaren zusammen, bis jedes Atom wieder voll ist.',
  ...
  error: {
    label: 'So nicht',
    atomFull:
      '{atom} hat schon 8 – mehr kann dieses Atom nicht teilen. Nimm ein Atom, das noch ein ungepaartes Elektron hat.',
    ...
    pairedDot:
      'Dieser Punkt gehört schon zu einem Paar. Nur ungepaarte Elektronen (die pulsierenden) lassen sich teilen.',
  },
  ...
  inspect: {
    ...
    explainNeedsDouble:
      '{atom1} und {atom2} haben beide noch ein ungepaartes Elektron – sie müssen zweimal teilen.',
    explainLeftover:
      'Bei {atom} ist ein ungepaartes Elektron übrig – da wurde ein Elektron zu viel gezeichnet.',
    ...
    repair:
      'Jetzt reparier sie: Bring die ungepaarten Elektronen zu Paaren zusammen, bis jedes Atom voll ist.',
  ...
  overlay: {
    ...
    levelUpSubtitle: 'Jedes ungepaarte Elektron hat einen Partner',
  ...
  glossary: {
    ...
    unpairedElectron: {
      term: 'ungepaartes Elektron',
      definition: 'ein Außenelektron ohne Partner; nur diese lassen sich teilen',
      matches: [
  ...
  ui: {
    ...
    atomLonerA11y: '{element}, ungepaartes Elektron {index} von {total}',
    atomLonePairA11y: '{element}, freies Elektronenpaar {index} von {total}',
    atomOrdinal: '{element} {ordinal}',
    unpairedLabel: 'ungepaartes Elektron',
    atomFull: 'voll',
    atomSelectedA11y:
      'Ungepaartes Elektron an {element} ausgewählt. Wähl jetzt ein ungepaartes Elektron an einem anderen Atom.',
