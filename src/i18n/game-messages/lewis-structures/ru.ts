...
export const ru = {
  ...
  instructions: {
    ...
    compact: [
      'Нажми на неспаренную точку, потом на точку другого атома.',
      'Атом заполнен при 8 точках, водороду хватает двух.',
      'Закрепляется само, когда все атомы заполнены. Кнопка не нужна.',
    ],
