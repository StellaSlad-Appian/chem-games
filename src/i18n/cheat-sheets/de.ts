...
export const RESOURCE_DESCRIPTIONS_DE: ResourceDescriptions = {
  ...
  'https://phet.colorado.edu/en/simulations/build-an-atom':
    'Setze Protonen, Neutronen und Elektronen zusammen und sieh zu, wie sich Element, Ladung und Masse dabei ändern.',
  'https://phet.colorado.edu/en/simulations/isotopes-and-atomic-mass':
    'Mische Isotope in verschiedenen Anteilen und beobachte, wie sich die relative Atommasse verschiebt.',
...
export const CHEAT_SHEET_OVERLAY_DE: CheatSheetOverlaySet = {
  'atomic-structure': {
    ...
    curriculumRef:
      'Victorian Curriculum Science Level 9: das Atom als kleinste Einheit eines Elements, die Kernbausteine, Ordnungszahl und Isotope. Die letzten beiden Abschnitte greifen in Klasse 10 und VCE Unit 1 vor.',
    keyTakeaways: [
