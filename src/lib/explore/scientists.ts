...
export const EXPLORE_SCIENTISTS: ExploreScientist[] = [
...

  {
    ...
    lifespan: '1898–1979',
    represents: 'woman',
    work: 'Katharine Blodgett worked out how to build a coating one molecule at a time. Her colleague Irving Langmuir had shown that a single layer of a fatty molecule spreads out across water. Blodgett found that if you dip a plate down through that layer and lift it out, the layer comes with it — and that you can dip it again, and again. In 1938, at General Electric, she stacked 44 layers of barium stearate onto glass and the glass stopped reflecting. Light bouncing off the top of the coating and light bouncing off the glass underneath come back out of step with each other, and cancel.',
...

  {
    ...
    lifespan: 'b. 1930',
    represents: 'woman',
    work: 'Malaria parasites had become resistant to the usual drugs, and in 1969 Tu Youyou was put in charge of her institute’s group inside Project 523, a secret Chinese search for a new one. Her team screened hundreds of plant extracts used in traditional medicine. Sweet wormwood worked sometimes and not others. Reading a fourth-century handbook of emergency prescriptions, she noticed that it said to soak the plant in cold water and wring out the juice — not to boil it. If heat was destroying the active compound, the extraction was the problem. She switched to ether, which boils at 35 °C, and in October 1971 got an extract that killed the parasites every time.',
...

  {
    ...
    lifespan: 'b. 1941',
    represents: 'man',
    work: 'Crystals repeat. That was not a guess, it was the definition: the atoms sit in a pattern that copies itself over and over in every direction, and such a pattern cannot have fivefold or tenfold symmetry — you cannot tile a floor with pentagons and leave no gaps. On 8 April 1982, on attachment from the Technion in Haifa to a US government laboratory, Dan Shechtman fired electrons through a rapidly cooled aluminium–manganese alloy and got a diffraction pattern with tenfold symmetry. His notebook entry for that sample reads “10 fold ???”. The atoms were perfectly ordered — you could say where the next one belonged — but the arrangement never repeated.',
