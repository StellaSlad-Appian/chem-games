...
export const COMPOUNDS_REGISTRY: CompoundData[] = [
  ...
  { 
    ...
    ionicComponents: { cations: [{ ionId: '1', count: 2 }], anions: [{ ionId: '27', count: 1 }] },
    isHazardous: false 
  },
  { 
    ...
    ionicComponents: { cations: [{ ionId: '1', count: 3 }], anions: [{ ionId: '29', count: 1 }] },
    isHazardous: true 
  },
  { 
  ...
  { 
    ...
    ionicComponents: { cations: [{ ionId: '1', count: 2 }], anions: [{ ionId: '28', count: 1 }] },
    isHazardous: true 
  },
  { 
