...
export const chemicalsDB: Chemical[] = [
  ...
  { 
    id: '2', formula: 'H₂SO₄', name: 'Sulfuric Acid', pKa: -3.0, 
    difficulty: 1, molarMass: 98.08, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'SO₄²-'], hazardClasses: ['Corrosive'] 
  },
  { 
    id: '3', formula: 'HNO₃', name: 'Nitric Acid', pKa: -1.4, 
    difficulty: 1, molarMass: 63.01, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'NO₃-'], hazardClasses: ['Corrosive', 'Oxidizer'] 
  },
  { 
  ...
  { 
    id: '9', formula: 'H₂CO₃', name: 'Carbonic Acid', pKa: 6.35, 
    difficulty: 2, molarMass: 62.03, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'HCO₃-'], hazardClasses: ['None'] 
  },
  { 
    id: '10', formula: 'H₃PO₄', name: 'Phosphoric Acid', pKa: 2.15, 
    difficulty: 2, molarMass: 98.00, stateAtRoomTemp: 'solid', 
    ions: ['H+', 'H₂PO₄-'], hazardClasses: ['Corrosive'] 
  },
  { 
    id: '11', formula: 'NH₃', name: 'Ammonia', pKb: 4.75, 
    difficulty: 2, molarMass: 17.03, stateAtRoomTemp: 'gas', 
    ions: ['NH₄+', 'OH-'], hazardClasses: ['Toxic', 'Corrosive'] 
  },
  { 
    id: '12', formula: 'CaCl₂', name: 'Calcium Chloride', 
    difficulty: 2, molarMass: 110.98, stateAtRoomTemp: 'solid', 
    ions: ['Ca²+', 'Cl-'], hazardClasses: ['Irritant'] 
  },
  { 
    id: '13', formula: 'MgCl₂', name: 'Magnesium Chloride', 
    difficulty: 2, molarMass: 95.21, stateAtRoomTemp: 'solid', 
    ions: ['Mg²+', 'Cl-'], hazardClasses: ['None'] 
  },
  { 
    id: '14', formula: 'Na₂SO₄', name: 'Sodium Sulfate', 
    difficulty: 2, molarMass: 142.04, stateAtRoomTemp: 'solid', 
    ions: ['Na+', 'SO₄²-'], hazardClasses: ['None'] 
  },
  ...
  // ==========================================
  { 
    id: '15', formula: 'H₂O', name: 'Water', pKa: 14.0, pKb: 14.0, 
    difficulty: 3, molarMass: 18.02, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'OH-'], hazardClasses: ['None'] 
  },
  { 
    id: '16', formula: 'NaHCO₃', name: 'Sodium Bicarbonate', pKa: 10.33, pKb: 7.65, 
    difficulty: 3, molarMass: 84.01, stateAtRoomTemp: 'solid', 
    ions: ['Na+', 'HCO₃-'], hazardClasses: ['None'] 
  },
  { 
    id: '17', formula: 'KHCO₃', name: 'Potassium Bicarbonate', pKa: 10.33, pKb: 7.65, 
    difficulty: 3, molarMass: 100.12, stateAtRoomTemp: 'solid', 
    ions: ['K+', 'HCO₃-'], hazardClasses: ['None'] 
  },
  { 
    id: '18', formula: 'HNO₂', name: 'Nitrous Acid', pKa: 3.39, 
    difficulty: 3, molarMass: 47.01, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'NO₂-'], hazardClasses: ['Toxic'] 
  },
  { 
    id: '19', formula: 'Ba(OH)₂', name: 'Barium Hydroxide', pKb: 0.64, 
    difficulty: 3, molarMass: 171.34, stateAtRoomTemp: 'solid', 
    ions: ['Ba²+', 'OH-'], hazardClasses: ['Toxic', 'Corrosive'] 
  },
  { 
    id: '20', formula: 'KNO₃', name: 'Potassium Nitrate', 
    difficulty: 3, molarMass: 101.10, stateAtRoomTemp: 'solid', 
    ions: ['K+', 'NO₃-'], hazardClasses: ['Oxidizer'] 
  },
  { 
  ...
  // ==========================================
  { 
    id: '22', formula: 'H₂SO₃', name: 'Sulfurous Acid', pKa: 1.85, 
    difficulty: 4, molarMass: 82.07, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'HSO₃-'], hazardClasses: ['Corrosive'] 
  },
  { 
    id: '23', formula: 'N₂H₄', name: 'Hydrazine', pKb: 5.77, 
    difficulty: 4, molarMass: 32.05, stateAtRoomTemp: 'liquid', 
    ions: ['N₂H₅+', 'OH-'], hazardClasses: ['Toxic', 'Flammable'] 
  },
  { 
  ...
  { 
    id: '26', formula: 'NaNO₃', name: 'Sodium Nitrate', 
    difficulty: 4, molarMass: 84.99, stateAtRoomTemp: 'solid', 
    ions: ['Na+', 'NO₃-'], hazardClasses: ['Oxidizer'] 
  },
  { 
    id: '27', formula: 'NaH₂PO₄', name: 'Sodium Dihydrogen Phosphate', pKa: 7.2, pKb: 11.85, 
    difficulty: 4, molarMass: 119.98, stateAtRoomTemp: 'solid', 
    ions: ['Na+', 'H₂PO₄-'], hazardClasses: ['None'] 
  },
  { 
    id: '28', formula: 'Na₂HPO₄', name: 'Disodium Hydrogen Phosphate', pKa: 12.35, pKb: 6.8, 
    difficulty: 4, molarMass: 141.96, stateAtRoomTemp: 'solid', 
    ions: ['Na+', 'HPO₄²-'], hazardClasses: ['None'] 
  },
  ...
  // ==========================================
  { 
    id: '29', formula: 'HClO₄', name: 'Perchloric Acid', pKa: -10.0, 
    difficulty: 5, molarMass: 100.46, stateAtRoomTemp: 'liquid', 
    ions: ['H+', 'ClO₄-'], hazardClasses: ['Oxidizer', 'Corrosive'] 
  },
  { 
  ...
  { 
    id: '32', formula: 'H₃BO₃', name: 'Boric Acid', pKa: 9.24, 
    difficulty: 5, molarMass: 61.83, stateAtRoomTemp: 'solid', 
    ions: ['H+', 'H₂BO₃-'], hazardClasses: ['Toxic'] 
  },
  { 
    id: '33', formula: 'H₄SiO₄', name: 'Silicic Acid', pKa: 9.82, 
    difficulty: 5, molarMass: 96.11, stateAtRoomTemp: 'solid', 
    ions: ['H+', 'H₃SiO₄-'], hazardClasses: ['None'] 
  },
  { 
  ...
  { 
    id: '35', formula: 'NaHSO₄', name: 'Sodium Bisulfate', pKa: 1.99, pKb: 17.0, 
    difficulty: 5, molarMass: 120.06, stateAtRoomTemp: 'solid', 
    ions: ['Na+', 'HSO₄-'], hazardClasses: ['Corrosive'] 
  }
];