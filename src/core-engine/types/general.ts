...
export interface UserProfile {
  id: string;
  alias: string; // The alias is always public
  labNotes: string; 
  favoriteElement: ChemicalTypeUserProfile | null; // Always public if selected
  joinedDate: string;
  totalSyntheses: number; 
  privacy: ProfilePrivacySettings; // New nested privacy controls
}