...
| [stoichiometry-game.md](./stoichiometry-game.md) | Reaction Factory — Year 9–10 reacting quantities (ratios, limiting reagent, Mr, mass by proportion; mole as a badged bonus). Rename to `reaction-factory.md` on approval | Draft rev 1 (scope decided, teacher-reviewed) | Medium | new `reacting-quantities` | `reactions.ts`, Year 10 Ar table, Reaction Balancer as prerequisite; feeds Mole Foundry |
